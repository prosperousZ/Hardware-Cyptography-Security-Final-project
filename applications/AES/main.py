...
def encryption(inputimage):
  ...
  # generate R share
  filename = "./outputs/R.png"
  cv2.imwrite(filename, R)

  # generate P share
  filename = "./outputs/P.png"
  ...
  f = open("./outputs/cipher.txt", "w", encoding = "utf-8")
  f.write(text)
  f.close() 
...
def decryption():
  ...
  f = open("./outputs/cipher.txt", "r", encoding = "utf-8")
  cipher = f.read()
  f.close()
  ...
  # read in two shares 
  P = cv2.imread("./outputs/P.png")
  R = cv2.imread("./outputs/R.png")
  ...
  with open("./outputs/decryptedImage.jpg", "wb") as f:
...
if __name__ == "__main__":
  ...
  MSE = performance.MSE(inputfile, "./outputs/decryptedImage.jpg")
  print("MSE = " + str(MSE))
  PSNR = performance.PSNR(inputfile, "./outputs/decryptedImage.jpg")
  print("PSNR = " + str(PSNR))
